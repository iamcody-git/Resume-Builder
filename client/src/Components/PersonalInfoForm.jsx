import { BriefcaseBusiness, Globe, icons, Key, Linkedin, Mail, MapPin, Phone, User, User2 } from 'lucide-react'
  ...
  return (
    <div>
      ...
      <div className='flex items-center gap-2'>
        <label>
            {data.image ?(
                <img src={typeof data.image == 'string'? data.image:URL.createObjectURL(data.image)} alt='username' className='w-16 h-16 rounded-full object-cover mt-5 ring ring-slate-500 hover:opacity-80' />
            ):(
